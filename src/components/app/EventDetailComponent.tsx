    ...
    return (
        <>
            <div className={cx(styles.sectionContainer, "bg-blue-50 mt-4 pb-4")}>
                <span className={cx(styles.textTitle)}>{dictionary.celebrate[language]}</span>

                <div className="flex flex-col md:grid md:grid-cols-2 mt-4 gap-4">
                    <div className={cx(styles.boxContainerWhite, "items-center")}>
                        <span className={cx(styles.textTitle2)}>{dictionary.holyMatrimony[language]}</span>
                    ...
                    <div className={cx(styles.boxContainerWhite, "items-center")}>
                        ...
                        <span className="mt-12"><b>{dictionary.ballromText[language]}</b></span>
